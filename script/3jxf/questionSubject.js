...
$task.fetch(request).then(response => {
        ...
        if(body.message == "请求成功"){
            $notify("三晋先锋","专题赛答题成功", "目前排名"+body.bestRank)}
        count +=2;
    }, reason => {
